...
public class AppEnvTest {
    @Test
    @DisplayName("It should load values from environment variables when they exist.\" (or) \"It must load values from environment variables when they exist.")
    ...
    @Test
    @DisplayName("It should use default values when variables do not exist.\" (or) \"It must use default values when variables do not exist.")
