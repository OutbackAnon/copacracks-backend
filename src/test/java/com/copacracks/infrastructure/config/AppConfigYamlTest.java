...
public class AppConfigYamlTest {
    ...
    class EdgeCaseTests {
        ...
        void shouldValidateValuesAreWithinExpectedRanges() {
            ...
            // Assert
            assertThat(db.maximumPoolSize())
                    .as("Pool size should be reasonable")
                    .isBetween(1, 100);

            assertThat(db.minimumIdle())
                    .as("Minimum idle should be reasonable")
                    .isBetween(0, 50);
        ...
        void shouldAcceptMinimumValidConfiguration() {
            ...
            // Assert
            assertSoftly(softly -> {
                softly.assertThat(config.getDatabase().maximumPoolSize())
                        .as("Should accept positive pool size")
                        .isGreaterThan(0);

                softly.assertThat(config.getDatabase().minimumIdle())
                        .as("Should accept non-negative idle")
                        .isGreaterThanOrEqualTo(0);

                softly.assertThat(config.getDatabase().driver())
        ...
        class EnvironmentSpecificTests {
            ...
            void prodConfigShouldHaveAppropriateValues() {
                ...
                // Assert
                assertThat(db.driver())
                        .as("Production should use PostgreSQL")
                        .contains("postgresql");

                assertThat(db.maximumPoolSize())
                        .as("Production should have larger pool")
                        .isGreaterThan(20);
            ...
            void localConfigShouldHaveDevelopmentValues() {
                ...
                // Assert
                assertThat(db.driver())
                        .as("Local should use H2 for testing")
                        .contains("h2");
